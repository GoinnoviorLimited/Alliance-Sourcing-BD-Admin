// components/admin/AdvanceMachineryList.jsx
"use client";
import Image from "next/image";
import { useState, useMemo } from "react";

export default function AdvanceMachineryList({ items, onEdit, onDelete, isDeleting }) {
  ...
  if (!items || items.length === 0) {
    return (
      <div className="text-center py-12 bg-gray-50 rounded-lg">
        ...
        <p className="text-gray-500 text-lg">No machinery items found</p>
        <p className="text-gray-400 mt-2">Add your first machinery item to get started</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative w-full sm:w-96">
        <input
          type="text"
          placeholder="Search machinery by label..."
          value={searchTerm}
      ...
      {filteredAndSortedItems.length === 0 && searchTerm && (
        <div className="text-center py-8">
          <p className="text-gray-500">No machinery found matching "{searchTerm}"</p>
        </div>
      )}
